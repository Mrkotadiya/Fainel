...
const Placeorder = ({ history }) => {
  const [confimOrder, setConfimOrder] = useState(true);
  ...
  const Placeorderhanlder = () => {
    ...
    setConfimOrder(false);
  };
  console.log(confimOrder);
          ...
          <div className="calculs-placeorder">
            ...
            {confimOrder && confimOrder ? (
              <div className="div-placeorder-btn">
                ...
                <div id="placeOrderReplce">
                <h2 id="orderConfimTittle">Your Order Have Been Confirm</h2>
