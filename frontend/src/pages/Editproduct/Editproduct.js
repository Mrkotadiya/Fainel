            ...
            <div className ='formedit'>
                ...
                Name :
                   ...
                   <div className="input-div one">
                      ...
                      <Checkbox onChange = {() =>{checkboxhandlercg('Meal') ; setWatchesselected(!Watchesselected)}} isChecked = {Watchesselected}>Meal </Checkbox>
                      <Checkbox onChange = {() =>{checkboxhandlercg('Coffee') ; setShoesselected(!Shoesselected)}} isChecked = {Shoesselected}>Coffee </Checkbox>
